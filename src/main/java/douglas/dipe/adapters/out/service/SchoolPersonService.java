...
public class SchoolPersonService {
    ...
    public SchoolPerson saveSchoolPerson(SchoolPersonDTO schoolPersonDTO) throws EntityAlreadyExistsException {
        var existent = schoolPersonRepository.findByCPF(schoolPersonDTO.cpf());

        if (existent.isPresent()) {
            throw new EntityAlreadyExistsException("School person data already exists. Checking the possibility of update, please!");
        }
